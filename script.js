...
function draw() {
    ...
    ctx.drawBreakingText(bottom, canvas.width / 2, _textSizeBottom - padding - height, null, 1, 'fill');
    ctx.drawBreakingText(bottom, canvas.width / 2, _textSizeBottom - padding - height, null, 1, 'stroke');
}


image.src = 'https://www.lolwhy.com/wp-content/uploads/2021/01/Funny-Pic-Baby-8-364x546.jpg';
